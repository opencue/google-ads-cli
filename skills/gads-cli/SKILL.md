...
name: gads-cli
description: >-
  Read and mutate any Google Ads account via the `gads` CLI. Use for
  budget changes, asset creation, bid strategy, performance reports, and
  campaign creation. Dry-run-by-default safety.
---
